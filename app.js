...
function win(userChoice, computerChoice){
  ...
  setTimeout(() => useChoice_div.classList.remove('green-glow'), 300);
}
...
function lose(userChoice, computerChoice){
  ...
  setTimeout(() => useChoice_div.classList.remove('red-glow'), 300);
}
...
function draw(userChoice, computerChoice){
  ...
  useChoice_div.classList.add('gray-glow');
  setTimeout(() => useChoice_div.classList.remove('gray-glow'), 300);
}
